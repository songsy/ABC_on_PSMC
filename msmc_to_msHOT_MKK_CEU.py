...
#python /home/songsy/script/pop-gen/msmc_to_msHOT_MKK_CEU.py --file1 ../MKK/NA21302_gvcf_msmc.final.txt --file2 ../CEU/NA12878_1KG_msmc.final.txt --file3 ../African_CEU/psmcfa/MKK-CEU-psmc.2.txt
#python /home/songsy/script/pop-gen/msmc_to_msHOT_MKK_CEU.py --file1 ../MKK/NA21302_gvcf_msmc.final.txt --file2 ../CEU/NA12878_1KG_msmc.final.txt --file3 ../African_CEU/psmcfa/MKK-CEU-shapeit-psmc.3.txt
#python /home/songsy/script/pop-gen/msmc_to_msHOT_MKK_CEU.py --file1 ../MKK/NA21302_gvcf_msmc.final.txt --file2 ../CEU/NA12878_1KG_msmc.final.txt --file3 ../African_CEU/psmcfa/MKK-CEU-psmc.3.txt
#python /home/songsy/script/pop-gen/msmc_to_msHOT_MKK_CEU.py --file1 ../MKK/NA21302_gvcf_msmc.final.txt --file2 ../CEU/NA12878_1KG_msmc.final.txt --file3 ../African_CEU/psmcfa/MKK-CEU-true-fosmid-psmc.3.txt
#python /home/songsy/script/pop-gen/msmc_to_msHOT_MKK_CEU.py --file1 ../../African/psmcfa/MKK-fosmid-psmc.0.txt --file2 ../../African/psmcfa/CEU-fosmid-psmc.0.txt --file3 ../../African_CEU/psmcfa/MKK-CEU-true-fosmid-psmc.3.txt
...
def msmc_to_msHOT_v2(file1,file2,file3,t,m,f_cmds,f_psmcfa,f_psmc): # have exponential growth
	theta = 4*int(args.N0)*float(args.mu)*int(args.L)
	pho = theta*0.13
	split_time = float(t*10000)/4/int(args.N0)/G
	CHECKPOINT=105660.301824
...
def msmc_to_msHOT_v4(file1,file2,file3,t,m,f_cmds,f_psmcfa,f_psmc):   # simulate  no exponential growth, use psmc as input
	theta = 4*int(args.N0)*float(args.mu)*int(args.L)
	pho = theta*0.13
	split_time = float(t*10000)/4/int(args.N0)/G
	CHECKPOINT=105660.301824
