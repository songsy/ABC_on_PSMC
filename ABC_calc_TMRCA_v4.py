...
def msmc_to_macs_no_checkpoint(file1,file2,file3,t,m,migration_end,CHECKPOINT): # have exponential growth 
	theta = 4*int(args.simN0)*float(args.mu)*int(args.L)
...
def print_macs_cmds(iter,Ntrial,tprior,mprior):
	...
	for i in range(Ntrial):
		...
		cmds=msmc_to_macs_no_checkpoint(args.file1,args.file2,args.file3,t,m,int(args.migration_end),args.checkpoint)
