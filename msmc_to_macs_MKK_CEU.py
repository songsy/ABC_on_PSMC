...
#python /home/songsy/script/pop-gen/msmc_to_macs_MKK_CEU.py --file1 ../../MKK/NA21302_gvcf_msmc.final.txt --file2 ../../NA12878/NA12878_1KG_msmc.final.txt --file3 ../../African_CEU/psmcfa/MKK-CEU-psmc.2.txt
import argparse
...
def msmc_to_msHOT_v2(file1,file2,file3,t,m,f_cmds,f_psmcfa,f_psmc):
	...
	cmds += '-n 1 %f -n 2 0.67628 -g 2 %f -eg 0.0086848 2 0 ' %(start_size,growth_factor)
	cmds += '-en 0.0087 2 %f ' %(size_before_growth)
