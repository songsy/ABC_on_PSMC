...
def read_sample(file):
	...
	for line in f:
		...
		if line[1]=='ASW':
			sample_list3.append(index)
		index+=1
	return sample_list1,sample_list2,sample_list3
...
def read_reference_SNP(SNP,hap_file,ASW_list,YRI_list,CEU_list,pos_index,index_to_pos):
	index = 0
	list = SNP.index
...
if __name__=="__main__":
	...
	YRI_list,CEU_list,ASW_list=read_sample(args.ref_dir+'ALL.integrated_phase1_v3.20101123.snps_indels_svs.genotypes.sample')
	chr = args.chr
	...
	SNP=read_reference_SNP(SNP,hap_file,YRI_list,CEU_list,ASW_list,pos_index,index_to_pos)
	ind = []
