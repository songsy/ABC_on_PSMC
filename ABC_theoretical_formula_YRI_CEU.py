...
#	psmc_result_matrix2=np.reshape(np.array(psmc_result2),(1,args.tprior2-args.tprior1+1,(args.mprior2-args.mprior1)/5+1))
...
def print_TMRCA_result_v2(tm_list,result):
	f=open('sim_macs_Mbuti_CEU_grid_TMRCA_psmc.txt','w')
	for i in range(len(tm_list)):
