...
import matplotlib ## inserted by Laura
matplotlib.use('Agg') ## inserted by Laura
import matplotlib.pyplot as plt
fig=plt.figure() ## inserted by Laura
import pylab
...
parser.add_option('--centromeres', default='/home/songsy/script/pop-gen/centromeres.bed')
parser.add_option('--pop_order', default=['AFR','EUR'], type='string', action='callback', callback=splitstr,
